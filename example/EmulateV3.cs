...
// Emulating a v3 device
// It seems that the protocol is the same to v2, but not confirmed with an actual v3 device
internal class EmulateV3
{
    private KiNetClient client;

    public EmulateV3(KiNetClient client)
    {
        this.client = client;
            ...
            case DiscoverPortsRequest request2:
                var response2 = new DiscoverPortsResponse
                {
                    ...
                    [
                        ...
                        {
                            Id = 2,
                            Type = DiscoverPortsResponse.PortData.PortTypes.VirtualPort
                        }
                    ]
                };
